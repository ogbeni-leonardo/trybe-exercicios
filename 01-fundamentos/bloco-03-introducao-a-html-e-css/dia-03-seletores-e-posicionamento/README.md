...
Copie os códigos abaixo e faça o que se pede:
...
_Personagens pertencentes à Nintendo©_
...
5. No arquivo **style.css**, adicione a propriedade `list-style: none` para ambas as listas.

## ATIVIDADE 04

Você não deve atribuir nenhuma classe ou id aos componentes, mas apenas utilizar as **_pseudoclasses_** para individualizar cada elemento!
...
1. Estilize todas as `div` para que, ao passar o cursor por cima delas, elas ganhem uma borda;
...
3. Faça todas as `li` terem 20px de tamanho de fonte e, para todo texto em itálico dentro de alguma `li`, utilize a propriedade **font-weight** para deixá-lo negrito;
